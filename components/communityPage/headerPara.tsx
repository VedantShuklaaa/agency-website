...
export default function HeaderPara() {
	return (
		<div className="w-full min-h-[40vh] lg:h-[60vh] flex border-b border-zinc-100 dark:border-zinc-900 bg-linear-to-b from-white via-teal-400 to-teal-600 p-4 gap-4">
			<div className="h-full lg:w-[40vw] xl:w-[30vw] w-full hidden lg:flex" />
			<div className="h-full w-full flex items-center justify-center ">
				<p className="font-twid text-body-md sm:text-heading-lg md:text-heading-xl text-black">
